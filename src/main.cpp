...
private:
    ...
    void initWindow()
    {
        ...
        auto windowGLFW = std::dynamic_pointer_cast<WindowGLFW>(window)->GetPointer();
        glfwSetWindowUserPointer(windowGLFW, this);
        glfwSetFramebufferSizeCallback(windowGLFW, framebufferResizeCallback);
    }
    ...
    void createGraphicsPipeline()
    {
        ...
        // Set up to create the pipeline
        VkPipelineShaderStageCreateInfo vertShaderStageInfo{};
        vertShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        vertShaderStageInfo.stage = VK_SHADER_STAGE_VERTEX_BIT;
        vertShaderStageInfo.module = vertShaderModule;
        vertShaderStageInfo.pName = "main";
        // You can set static variables with this
        // this allows for some branch optimisation
        ...
        // Vertex input
        // we are specifying that there will be no input since we already have vertex data
        ...
        // Ther may problems with alpha blending here
    ...
    static std::vector<char> readFile(const std::string &filename)
    {
        ...
        std::cout << filename << " Size: " << sizeof(buffer) << "\n";
    ...
    VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities)
    {
        ...
        {
            int width, height;
            window->WindowPixelResolution(width, height);
    ...
    void createSyncObjects()
    {
        ...
        fenceInfo.flags = VK_FENCE_CREATE_SIGNALED_BIT; // Avoids blocking 1st frame
